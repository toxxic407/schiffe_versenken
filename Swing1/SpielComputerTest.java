...
public class SpielComputerTest {
	...
	private static int indexToAttackNext;
	/*
	...
	private static boolean iAmClientAndSentFirstAttackAlready;		// used to make the Client send the first attack
	...
	public static void spawnEnemyField() {
		...
		for (int i = 0; i < 64; i++) {
			...
			temp.setEnabled(false);		// since this is a bot player, buttons should be disabled
